  ...
  const handleMouseLeave = (index) => {
    setHoveredImages({ ...hoveredImages, [index]: false });
        ...
        return (
          ...
          <React.Fragment>
             <Novigation/>
               <div className="bracelets-info">
             
                <h2>BRACELETS</h2>
                </div>
                <div className="bracelets-div" >
                   {props.pages.bracelets.map((obj, index)=>
                 <div className="bracelet-inner-div" key={index}>
                  <img
...
export default connect(mapStateToProps,mapDispatchToProps)(BraceletPage)
